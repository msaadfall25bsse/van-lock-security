...
export const metadata: Metadata = {
  title: "Transporter T6.1 2020> - VanLock Security",
  description:
    "VW Transporter T6.1 2020> Locks and Security Solutions. Browse L4V's range of locks and security solutions for the Volkswagen Transporter T6.1 2020>. Call 07367674000.",
};
...
export default function VWTransporterT612020Page() {
  return (
    <div className="min-h-screen bg-white text-[#303030] font-manrope selection:bg-[#2282C6] selection:text-white">
      ...
      <main>
        {/* ========================================================================= */}
        {/* SECTION 1: HERO SECTION - VW Transporter T6.1 2020>                       */}
        {/* ========================================================================= */}
          ...
          <div className="max-w-[1300px] mx-auto">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-10">
              ...
              <div className="w-full lg:w-1/2 flex flex-col items-start justify-center lg:pr-[20px]">
                <h1 className="font-jakarta text-[28px] sm:text-[34px] lg:text-[38px] font-bold text-[#000000] leading-[1.2] tracking-[-0.5px] capitalize mb-5">
                  VW Transporter T6.1 2020&gt; Locks<br className="hidden sm:inline" /> And Security Solutions
                </h1>

                <div className="font-manrope text-[16px] lg:text-[18px] text-[#333333] leading-[28px] lg:leading-[30px] mb-8 font-normal lg:pr-[16%]">
                  <p>
                    Browse L4V&apos;s range of locks and security solutions for the Volkswagen Transporter T6.1 2020&gt;
                  </p>
                </div>
              ...
              <div className="w-full lg:w-1/2 flex items-center justify-center lg:pl-[20px]">
                <div className="relative w-full max-w-[580px] aspect-[4/3] flex items-center justify-center">
                  <Image
                    src="/Volkswagen-Transporter-T5-2003-2014-c17c2853-1.png"
                    alt="VW Transporter T6.1 2020>"
                    fill
                    priority
