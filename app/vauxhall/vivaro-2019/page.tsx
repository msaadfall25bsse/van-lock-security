...
export const metadata: Metadata = {
  title: "Vivaro 2019> - VanLock Security",
  description:
    "Vauxhall Vivaro 2019> Locks and Security Solutions. Browse L4V's range of locks and security solutions for the Vauxhall Vivaro 2019>. Call 07367674000.",
};
...
export default function VauxhallVivaro2019Page() {
  return (
    <div className="min-h-screen bg-white text-[#303030] font-manrope selection:bg-[#2282C6] selection:text-white">
      ...
      <main>
        {/* ========================================================================= */}
        {/* SECTION 1: HERO SECTION - Vauxhall Vivaro 2019>                           */}
        {/* ========================================================================= */}
          ...
          <div className="max-w-[1300px] mx-auto">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-10">
              ...
              <div className="w-full lg:w-1/2 flex flex-col items-start justify-center lg:pr-[20px]">
                <h1 className="font-onest text-[28px] sm:text-[34px] lg:text-[38px] font-semibold text-[#000000] leading-[1.25] lg:leading-[48px] capitalize mb-2">
                  Vauxhall Vivaro 2019&gt; Locks<br className="hidden sm:inline" /> And Security Solutions
                </h1>

                {/* Specific Subtitle for Vivaro */}
                <h2 className="font-onest text-[18px] sm:text-[20px] font-semibold text-[#2282C6] mb-5">
                ...
                <div className="font-manrope text-[16px] lg:text-[18px] text-[#333333] leading-[28px] lg:leading-[30px] mb-8 font-normal lg:pr-[16%]">
                  <p>
                    Browse L4V&apos;s range of locks and security solutions for the Vauxhall Vivaro 2019&gt;
                  </p>
                </div>
              ...
              <div className="w-full lg:w-1/2 flex items-center justify-center lg:pl-[20px]">
                <div className="relative w-full max-w-[580px] aspect-[4/3] flex items-center justify-center">
                  <Image
                    src="/Vauxhall-Vivaro-2019-d190905d-1-1.png"
                    alt="Vauxhall Vivaro 2019>"
                    fill
                    priority
