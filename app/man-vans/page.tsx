...
export const metadata: Metadata = {
  title: 'MAN Vans - VanLock Security',
  description: 'MAN vans are known for their robust performance, innovative technology, and high reliability. Designed to handle both urban and long-distance transport, they offer excellent fuel efficiency and comfort. Please select your vehicle below. Security solutions for MAN',
};

const manVehicles = [
  {
    name: 'TGE 2017>',
    slug: '/man-vans/tge-2017/',
    image: '/man-tge-2017.jpeg',
  },
];

export default function ManVansPage() {
  return (
    <main className="min-h-screen bg-white font-sans text-[#111111] overflow-x-hidden">
      ...
      <section className="bg-[#EBF6FC] pt-14 pb-16 sm:pt-16 sm:pb-20">
        <div className="max-w-[850px] mx-auto px-4 sm:px-6 text-center flex flex-col items-center">
          {/* Centered MAN Brand Logo */}
          <div className="relative w-[180px] h-[90px] sm:w-[210px] sm:h-[105px] mb-6">
            <Image
              src="/man-hero-logo.png"
              alt="MAN Logo"
              fill
          ...
          <p className="font-manrope text-[15px] sm:text-[17px] text-[#2b2b2b] leading-[26px] sm:leading-[28px] max-w-[760px]">
            MAN vans are known for their robust performance, innovative technology, and high reliability. Designed to handle both urban and long-distance transport, they offer excellent fuel efficiency and comfort.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12 sm:mb-14">
            ...
            <h2 className="font-jakarta text-[30px] sm:text-[38px] lg:text-[44px] font-bold text-[#050B20] tracking-tight">
              Security Solutions For MAN
            </h2>
          </div>

          {/* Responsive Grid */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {manVehicles.map((vehicle, idx) => (
              <Link
                key={idx}
                href={vehicle.slug}
