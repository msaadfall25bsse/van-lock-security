...
export const metadata: Metadata = {
  title: 'Land Rover - VanLock Security',
  description: 'Land Rover cars are known for their rugged performance, luxury design, and off-road capabilities. Built with advanced technology, they offer a smooth drive on both city roads and tough terrains. Please select your vehicle below. Security solutions for Land Rover',
};

const landRoverVehicles = [
  {
    name: 'Defender 2002>',
    slug: '/land-rover/defender-2002/',
    image: '/defender-thumbnail.jpeg',
  },
];
      ...
      <section className="bg-[#EBF6FC] pt-14 pb-16 sm:pt-16 sm:pb-20">
        <div className="max-w-[850px] mx-auto px-4 sm:px-6 text-center flex flex-col items-center">
          ...
          <p className="font-manrope text-[15px] sm:text-[17px] text-[#2b2b2b] leading-[26px] sm:leading-[28px] max-w-[760px]">
            Land Rover cars are known for their rugged performance, luxury design, and off-road capabilities. Built with advanced technology, they offer a smooth drive on both city roads and tough terrains.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white pt-14 pb-20 sm:pt-16 sm:pb-24">
        <div className="max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {landRoverVehicles.map((vehicle, idx) => (
              <Link
                key={idx}
                href={vehicle.slug}
